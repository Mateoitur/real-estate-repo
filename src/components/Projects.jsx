...
const prevProject = ()=>{
  ...
  return (
    ...
    <div className='flex justify-end items-center mb-8'>
        ...
        className='cursor-pointer p-3 bg-gray-200 rounded mr-2' aria-label='Previous Project'>
            <img src={assets.left_arrow} alt="Previous" />
        </button>

        <button onClick={nextProject}
        className='cursor-pointer p-3 bg-gray-200 rounded mr-2' aria-label='Next Project'>
